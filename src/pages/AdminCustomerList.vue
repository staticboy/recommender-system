...
function toggleModel() {
  showModal.value = !showModal.value; // Toggle the value (true to false, false to true)
}
</script>
...
<template>
  ...
  <tbody>
    <tr>
      ...
      <td>10</td>
      <td><router-link to="/adm-customer-profile" class="btn">Open Profile</router-link></td>
    </tr>
    <tr>
      <td>2</td>
      <td>Rafael Nadal</td>
