  ...
  <tbody>
    ...
    <tr>
      ...
      <td>New Balance</td>
                ...
                <div class="first-child-internal">
                    <h5>Data Count Monitor</h5>
                    <h1 id="data-count">255</h1>
                </div>
            </div>
...
#first-child{
  display: grid;
  grid-template-areas:'rager rager query ccount';
  gap: 10px;
...
#first-child > div td, #first-child > div th{
    padding: 0;
}


/*****
GRID CONTENT TAGGING
*/
.first-child-internal:first-child { grid-area: rager; }
.first-child-internal:nth-child(2) { grid-area: query; }
.first-child-internal:last-child { grid-area: ccount; }


.second-child-internal:first-child { grid-area: _line; }
.second-child-internal:last-child { grid-area: _bar; }
